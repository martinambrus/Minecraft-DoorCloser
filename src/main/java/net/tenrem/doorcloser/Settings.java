...
public class Settings 
{
	...
	{		
		...
		ThisPlugin.getLogger().info("Only auto-close if sneaking and left-clicked: " + Settings.onlyIfSneakingAndLeftClicked);
		ThisPlugin.getLogger().info("Only players who toggled DoorCloser have the functionality: " + Settings.onlyForToggledPlayers);
		ThisPlugin.getLogger().info("Default toggle value for new players: " + Settings.toggleDefault);
